...
def FlagsForFile( filename, **kwargs ):
  if database:
    ...
    if filename.endswith(".c") or filename.endswith(".h"):
        full_flags = flags + flags_c
    elif filename.endswith(".cpp") or filename.endswith(".cc") or filename.endswith(".hpp"):
        full_flags = flags + flags_cpp
    else:
        full_flags = flags + flags_c

    final_flags = MakeRelativePathsInFlagsAbsolute( full_flags, relative_to )
