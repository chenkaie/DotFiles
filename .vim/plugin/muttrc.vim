...
syn keyword muttrcVarBool	skipwhite contained fcc_attach fcc_clear followup_to force_name forw_decode nextgroup=muttrcSetBoolAssignment,muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarBool	skipwhite contained hide_top_missing ignore_linear_white_space ignore_list_reply_to imap_check_subscribed nextgroup=muttrcSetBoolAssignment,muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarBool	skipwhite contained nofcc_attach nofcc_clear nofollowup_to noforce_name noforw_decode nextgroup=muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarBool	skipwhite contained nohide_top_missing noignore_list_reply_to noimap_check_subscribed nextgroup=muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarBool	skipwhite contained invfcc_attach invfcc_clear invfollowup_to invforce_name invforw_decode nextgroup=muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarBool	skipwhite contained invhide_top_missing invignore_list_reply_to invimap_check_subscribed nextgroup=muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarQuad	skipwhite contained crypt_verify_sig delete forward_edit honor_followup_to nextgroup=muttrcSetQuadAssignment,muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarQuad	skipwhite contained nocrypt_verify_sig nodelete noforward_edit nohonor_followup_to nextgroup=muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarQuad	skipwhite contained invcrypt_verify_sig invdelete invforward_edit invhonor_followup_to nextgroup=muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
...
syn keyword muttrcVarNum	skipwhite contained score_threshold_flag score_threshold_read sendmail_wait sleep_time nextgroup=muttrcSetNumAssignment,muttrcVPrefix,muttrcVarBool,muttrcVarQuad,muttrcVarNum,muttrcVarStr
