...
if !exists("xmllint_command")
  let xmllint_command = 'xmllint'
endif

if !exists("xmllint_command_options")
  let xmllint_command_options = '--noout'
endif

if !exists("xmllint_highlight_color")
  let xmllint_highlight_color = 'DarkMagenta'
endif

" set up auto commands! 20090610 Kent, comment autocmd, call this function by ':Call XMLLint()'
"autocmd BufWritePost,FileWritePost *.xml call XMLLint()
...
function XMLLint() 
  ...
  let cmd_output = system(g:xmllint_command . ' ' . g:xmllint_command_options . ' ' . current_file)
...
function s:SetCursorLineColor() 
  ...
  execute "highlight CursorLine guibg=" . g:xmllint_highlight_color
endfunction
